...
@include('admin.header')
        ...
        <div class="flex justify-center gap-8">
           <div class="bg-white rounded-lg shadow-lg p-4">
            ...
            @csrf
                <label class="text-center font-bold text-blue-500 text-2xl  tracking-widest" for="">zone and Wereda Excel</label>
            <div class="flex-initial mt-5 ">
                  <a href="{{route('exportzonewereda')}}" type="submit" name="submit" id="submit" class="px-4 py-2  font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
            ...
            <form id="my-form" method="POST" action="{{route('importzonewereda')}}" enctype="multipart/form-data">
            @csrf
