...
<div class=" sm:max-w-md border-blue-300 shadow-md px-16 border m-auto rounded-lg">
  ...
  <div class="mt-10 sm:mx-auto   ">
    <form class="space-y-6" action="{{route('new.regster')}}" method="POST"  enctype="multipart/form-data">
      @csrf
      <div>
        <label for="name" class="block text-sm  font-bold leading-6 text-gray-900">full name</label>
        <div class="mt-2">
          <input id="name" name="name" type="text" autocomplete="name"  class="block px-2 font-bold w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
      </div>
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="email" name="email" type="email" autocomplete="current-password"  class="block w-full px-2 text-bold rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
      </div>
    ...
    <p class="mt-10 p-10 text-center text-sm text-gray-500">
      are you admin?
      <a href="{{route('login')}}" class="font-semibold  leading-6 text-indigo-600 hover:text-indigo-500">login for account </a>
    </p>
  </div>
</div>
</div>
